...
type TicketOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TicketOutline({ extraStyles, extraClasses, ...rest }: TicketOutlineProps) {
  const defaultProps: TicketOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TicketOutlineProps = { ...defaultProps, ...rest }
