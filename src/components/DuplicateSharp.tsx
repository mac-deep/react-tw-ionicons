...
type DuplicateSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function DuplicateSharp({ extraStyles, extraClasses, ...rest }: DuplicateSharpProps) {
  const defaultProps: DuplicateSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DuplicateSharpProps = { ...defaultProps, ...rest }
