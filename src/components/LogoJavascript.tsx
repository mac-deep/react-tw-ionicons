...
type LogoJavascriptProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoJavascript({ extraStyles, extraClasses, ...rest }: LogoJavascriptProps) {
  const defaultProps: LogoJavascriptProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoJavascriptProps = { ...defaultProps, ...rest }
