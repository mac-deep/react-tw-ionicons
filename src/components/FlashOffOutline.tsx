...
type FlashOffOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FlashOffOutline({ extraStyles, extraClasses, ...rest }: FlashOffOutlineProps) {
  const defaultProps: FlashOffOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlashOffOutlineProps = { ...defaultProps, ...rest }
