...
type AmericanFootballSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AmericanFootballSharp({ extraStyles, extraClasses, ...rest }: AmericanFootballSharpProps) {
  const defaultProps: AmericanFootballSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AmericanFootballSharpProps = { ...defaultProps, ...rest }
