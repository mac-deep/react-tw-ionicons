...
type AnalyticsSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AnalyticsSharp({ extraStyles, extraClasses, ...rest }: AnalyticsSharpProps) {
  const defaultProps: AnalyticsSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AnalyticsSharpProps = { ...defaultProps, ...rest }
