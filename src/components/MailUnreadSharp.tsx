...
type MailUnreadSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MailUnreadSharp({ extraStyles, extraClasses, ...rest }: MailUnreadSharpProps) {
  const defaultProps: MailUnreadSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MailUnreadSharpProps = { ...defaultProps, ...rest }
