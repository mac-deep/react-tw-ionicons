...
type FootstepsOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FootstepsOutline({ extraStyles, extraClasses, ...rest }: FootstepsOutlineProps) {
  const defaultProps: FootstepsOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FootstepsOutlineProps = { ...defaultProps, ...rest }
