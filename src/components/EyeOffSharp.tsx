...
type EyeOffSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function EyeOffSharp({ extraStyles, extraClasses, ...rest }: EyeOffSharpProps) {
  const defaultProps: EyeOffSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EyeOffSharpProps = { ...defaultProps, ...rest }
