...
type HeartDislikeSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartDislikeSharp({ extraStyles, extraClasses, ...rest }: HeartDislikeSharpProps) {
  const defaultProps: HeartDislikeSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartDislikeSharpProps = { ...defaultProps, ...rest }
