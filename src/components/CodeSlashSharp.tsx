...
type CodeSlashSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CodeSlashSharp({ extraStyles, extraClasses, ...rest }: CodeSlashSharpProps) {
  const defaultProps: CodeSlashSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CodeSlashSharpProps = { ...defaultProps, ...rest }
