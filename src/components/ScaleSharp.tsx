...
type ScaleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ScaleSharp({ extraStyles, extraClasses, ...rest }: ScaleSharpProps) {
  const defaultProps: ScaleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ScaleSharpProps = { ...defaultProps, ...rest }
