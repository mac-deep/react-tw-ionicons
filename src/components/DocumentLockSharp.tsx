...
type DocumentLockSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function DocumentLockSharp({ extraStyles, extraClasses, ...rest }: DocumentLockSharpProps) {
  const defaultProps: DocumentLockSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DocumentLockSharpProps = { ...defaultProps, ...rest }
