...
export default function LogoRss({ extraStyles, extraClasses, ...rest }: LogoRssProps) {
  const defaultProps: LogoRssProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoRssProps = { ...defaultProps, ...rest }
