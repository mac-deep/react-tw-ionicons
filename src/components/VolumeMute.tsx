...
type VolumeMuteProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VolumeMute({ extraStyles, extraClasses, ...rest }: VolumeMuteProps) {
  const defaultProps: VolumeMuteProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VolumeMuteProps = { ...defaultProps, ...rest }
