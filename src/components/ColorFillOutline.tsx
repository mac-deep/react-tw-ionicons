...
type ColorFillOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ColorFillOutline({ extraStyles, extraClasses, ...rest }: ColorFillOutlineProps) {
  const defaultProps: ColorFillOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ColorFillOutlineProps = { ...defaultProps, ...rest }
