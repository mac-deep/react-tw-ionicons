...
type CameraSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CameraSharp({ extraStyles, extraClasses, ...rest }: CameraSharpProps) {
  const defaultProps: CameraSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CameraSharpProps = { ...defaultProps, ...rest }
