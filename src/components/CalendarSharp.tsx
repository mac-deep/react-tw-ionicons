...
type CalendarSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CalendarSharp({ extraStyles, extraClasses, ...rest }: CalendarSharpProps) {
  const defaultProps: CalendarSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CalendarSharpProps = { ...defaultProps, ...rest }
