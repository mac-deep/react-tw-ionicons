...
type DocumentSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function DocumentSharp({ extraStyles, extraClasses, ...rest }: DocumentSharpProps) {
  const defaultProps: DocumentSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DocumentSharpProps = { ...defaultProps, ...rest }
