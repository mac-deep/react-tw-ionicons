...
type LogoGitlabProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoGitlab({ extraStyles, extraClasses, ...rest }: LogoGitlabProps) {
  const defaultProps: LogoGitlabProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoGitlabProps = { ...defaultProps, ...rest }
