...
export default function AtOutline({ extraStyles, extraClasses, ...rest }: AtOutlineProps) {
  const defaultProps: AtOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AtOutlineProps = { ...defaultProps, ...rest }
