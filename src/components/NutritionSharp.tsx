...
type NutritionSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NutritionSharp({ extraStyles, extraClasses, ...rest }: NutritionSharpProps) {
  const defaultProps: NutritionSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NutritionSharpProps = { ...defaultProps, ...rest }
