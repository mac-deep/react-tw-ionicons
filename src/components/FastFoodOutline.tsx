...
type FastFoodOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FastFoodOutline({ extraStyles, extraClasses, ...rest }: FastFoodOutlineProps) {
  const defaultProps: FastFoodOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FastFoodOutlineProps = { ...defaultProps, ...rest }
