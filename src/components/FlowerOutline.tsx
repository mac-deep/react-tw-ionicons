...
type FlowerOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FlowerOutline({ extraStyles, extraClasses, ...rest }: FlowerOutlineProps) {
  const defaultProps: FlowerOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlowerOutlineProps = { ...defaultProps, ...rest }
