...
type PartlySunnyOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PartlySunnyOutline({ extraStyles, extraClasses, ...rest }: PartlySunnyOutlineProps) {
  const defaultProps: PartlySunnyOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PartlySunnyOutlineProps = { ...defaultProps, ...rest }
