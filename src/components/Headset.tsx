...
export default function Headset({ extraStyles, extraClasses, ...rest }: HeadsetProps) {
  const defaultProps: HeadsetProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeadsetProps = { ...defaultProps, ...rest }
