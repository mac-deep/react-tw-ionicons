...
type KeyOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function KeyOutline({ extraStyles, extraClasses, ...rest }: KeyOutlineProps) {
  const defaultProps: KeyOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: KeyOutlineProps = { ...defaultProps, ...rest }
