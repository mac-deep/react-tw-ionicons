...
type NutritionOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NutritionOutline({ extraStyles, extraClasses, ...rest }: NutritionOutlineProps) {
  const defaultProps: NutritionOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NutritionOutlineProps = { ...defaultProps, ...rest }
