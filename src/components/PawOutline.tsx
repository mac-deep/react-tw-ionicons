...
type PawOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PawOutline({ extraStyles, extraClasses, ...rest }: PawOutlineProps) {
  const defaultProps: PawOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PawOutlineProps = { ...defaultProps, ...rest }
