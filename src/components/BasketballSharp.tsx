...
type BasketballSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BasketballSharp({ extraStyles, extraClasses, ...rest }: BasketballSharpProps) {
  const defaultProps: BasketballSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BasketballSharpProps = { ...defaultProps, ...rest }
