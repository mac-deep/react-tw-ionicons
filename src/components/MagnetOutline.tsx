...
type MagnetOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MagnetOutline({ extraStyles, extraClasses, ...rest }: MagnetOutlineProps) {
  const defaultProps: MagnetOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MagnetOutlineProps = { ...defaultProps, ...rest }
