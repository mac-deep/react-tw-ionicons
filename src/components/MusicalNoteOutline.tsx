...
type MusicalNoteOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MusicalNoteOutline({ extraStyles, extraClasses, ...rest }: MusicalNoteOutlineProps) {
  const defaultProps: MusicalNoteOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MusicalNoteOutlineProps = { ...defaultProps, ...rest }
