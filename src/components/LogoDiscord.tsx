...
type LogoDiscordProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoDiscord({ extraStyles, extraClasses, ...rest }: LogoDiscordProps) {
  const defaultProps: LogoDiscordProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoDiscordProps = { ...defaultProps, ...rest }
