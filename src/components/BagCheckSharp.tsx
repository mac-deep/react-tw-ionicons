...
type BagCheckSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BagCheckSharp({ extraStyles, extraClasses, ...rest }: BagCheckSharpProps) {
  const defaultProps: BagCheckSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BagCheckSharpProps = { ...defaultProps, ...rest }
