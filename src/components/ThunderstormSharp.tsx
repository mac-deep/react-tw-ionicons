...
type ThunderstormSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ThunderstormSharp({ extraStyles, extraClasses, ...rest }: ThunderstormSharpProps) {
  const defaultProps: ThunderstormSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThunderstormSharpProps = { ...defaultProps, ...rest }
