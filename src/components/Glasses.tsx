...
export default function Glasses({ extraStyles, extraClasses, ...rest }: GlassesProps) {
  const defaultProps: GlassesProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GlassesProps = { ...defaultProps, ...rest }
