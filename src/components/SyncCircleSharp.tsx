...
type SyncCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SyncCircleSharp({ extraStyles, extraClasses, ...rest }: SyncCircleSharpProps) {
  const defaultProps: SyncCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SyncCircleSharpProps = { ...defaultProps, ...rest }
