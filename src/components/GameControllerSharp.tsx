...
type GameControllerSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function GameControllerSharp({ extraStyles, extraClasses, ...rest }: GameControllerSharpProps) {
  const defaultProps: GameControllerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GameControllerSharpProps = { ...defaultProps, ...rest }
