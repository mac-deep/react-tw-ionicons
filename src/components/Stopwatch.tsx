...
export default function Stopwatch({ extraStyles, extraClasses, ...rest }: StopwatchProps) {
  const defaultProps: StopwatchProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: StopwatchProps = { ...defaultProps, ...rest }
