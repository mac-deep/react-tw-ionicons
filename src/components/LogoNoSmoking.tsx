...
type LogoNoSmokingProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoNoSmoking({ extraStyles, extraClasses, ...rest }: LogoNoSmokingProps) {
  const defaultProps: LogoNoSmokingProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoNoSmokingProps = { ...defaultProps, ...rest }
