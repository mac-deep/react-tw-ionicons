...
type MailUnreadProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MailUnread({ extraStyles, extraClasses, ...rest }: MailUnreadProps) {
  const defaultProps: MailUnreadProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MailUnreadProps = { ...defaultProps, ...rest }
