...
type ArrowRedoCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ArrowRedoCircle({ extraStyles, extraClasses, ...rest }: ArrowRedoCircleProps) {
  const defaultProps: ArrowRedoCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ArrowRedoCircleProps = { ...defaultProps, ...rest }
