...
type ColorPaletteSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ColorPaletteSharp({ extraStyles, extraClasses, ...rest }: ColorPaletteSharpProps) {
  const defaultProps: ColorPaletteSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ColorPaletteSharpProps = { ...defaultProps, ...rest }
