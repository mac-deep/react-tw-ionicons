...
type MusicalNoteSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MusicalNoteSharp({ extraStyles, extraClasses, ...rest }: MusicalNoteSharpProps) {
  const defaultProps: MusicalNoteSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MusicalNoteSharpProps = { ...defaultProps, ...rest }
