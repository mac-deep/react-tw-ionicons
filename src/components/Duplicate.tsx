...
export default function Duplicate({ extraStyles, extraClasses, ...rest }: DuplicateProps) {
  const defaultProps: DuplicateProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DuplicateProps = { ...defaultProps, ...rest }
