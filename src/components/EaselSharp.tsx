...
type EaselSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function EaselSharp({ extraStyles, extraClasses, ...rest }: EaselSharpProps) {
  const defaultProps: EaselSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EaselSharpProps = { ...defaultProps, ...rest }
