...
type HeartCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartCircleSharp({ extraStyles, extraClasses, ...rest }: HeartCircleSharpProps) {
  const defaultProps: HeartCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartCircleSharpProps = { ...defaultProps, ...rest }
