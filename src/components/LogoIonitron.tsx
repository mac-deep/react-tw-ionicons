...
type LogoIonitronProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoIonitron({ extraStyles, extraClasses, ...rest }: LogoIonitronProps) {
  const defaultProps: LogoIonitronProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoIonitronProps = { ...defaultProps, ...rest }
