...
type GitNetworkSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function GitNetworkSharp({ extraStyles, extraClasses, ...rest }: GitNetworkSharpProps) {
  const defaultProps: GitNetworkSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GitNetworkSharpProps = { ...defaultProps, ...rest }
