...
type LogoOctocatProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoOctocat({ extraStyles, extraClasses, ...rest }: LogoOctocatProps) {
  const defaultProps: LogoOctocatProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoOctocatProps = { ...defaultProps, ...rest }
