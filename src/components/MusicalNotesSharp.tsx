...
type MusicalNotesSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MusicalNotesSharp({ extraStyles, extraClasses, ...rest }: MusicalNotesSharpProps) {
  const defaultProps: MusicalNotesSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MusicalNotesSharpProps = { ...defaultProps, ...rest }
