...
export default function KeySharp({ extraStyles, extraClasses, ...rest }: KeySharpProps) {
  const defaultProps: KeySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: KeySharpProps = { ...defaultProps, ...rest }
