...
type LogoAmazonProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoAmazon({ extraStyles, extraClasses, ...rest }: LogoAmazonProps) {
  const defaultProps: LogoAmazonProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoAmazonProps = { ...defaultProps, ...rest }
