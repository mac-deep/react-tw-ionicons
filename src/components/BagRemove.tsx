...
export default function BagRemove({ extraStyles, extraClasses, ...rest }: BagRemoveProps) {
  const defaultProps: BagRemoveProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BagRemoveProps = { ...defaultProps, ...rest }
