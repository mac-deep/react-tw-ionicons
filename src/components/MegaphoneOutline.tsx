...
type MegaphoneOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MegaphoneOutline({ extraStyles, extraClasses, ...rest }: MegaphoneOutlineProps) {
  const defaultProps: MegaphoneOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MegaphoneOutlineProps = { ...defaultProps, ...rest }
