...
type LogoAlipayProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoAlipay({ extraStyles, extraClasses, ...rest }: LogoAlipayProps) {
  const defaultProps: LogoAlipayProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoAlipayProps = { ...defaultProps, ...rest }
