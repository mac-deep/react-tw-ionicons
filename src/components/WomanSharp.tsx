...
type WomanSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function WomanSharp({ extraStyles, extraClasses, ...rest }: WomanSharpProps) {
  const defaultProps: WomanSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: WomanSharpProps = { ...defaultProps, ...rest }
