...
type FitnessSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FitnessSharp({ extraStyles, extraClasses, ...rest }: FitnessSharpProps) {
  const defaultProps: FitnessSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FitnessSharpProps = { ...defaultProps, ...rest }
