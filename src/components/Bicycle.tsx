...
export default function Bicycle({ extraStyles, extraClasses, ...rest }: BicycleProps) {
  const defaultProps: BicycleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BicycleProps = { ...defaultProps, ...rest }
