...
export default function CarSharp({ extraStyles, extraClasses, ...rest }: CarSharpProps) {
  const defaultProps: CarSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CarSharpProps = { ...defaultProps, ...rest }
