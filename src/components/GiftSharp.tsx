...
export default function GiftSharp({ extraStyles, extraClasses, ...rest }: GiftSharpProps) {
  const defaultProps: GiftSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GiftSharpProps = { ...defaultProps, ...rest }
