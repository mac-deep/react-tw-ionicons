...
type LogoPythonProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoPython({ extraStyles, extraClasses, ...rest }: LogoPythonProps) {
  const defaultProps: LogoPythonProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoPythonProps = { ...defaultProps, ...rest }
