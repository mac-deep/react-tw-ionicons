...
type LogoDockerProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoDocker({ extraStyles, extraClasses, ...rest }: LogoDockerProps) {
  const defaultProps: LogoDockerProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoDockerProps = { ...defaultProps, ...rest }
