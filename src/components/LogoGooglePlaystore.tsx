...
type LogoGooglePlaystoreProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoGooglePlaystore({ extraStyles, extraClasses, ...rest }: LogoGooglePlaystoreProps) {
  const defaultProps: LogoGooglePlaystoreProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoGooglePlaystoreProps = { ...defaultProps, ...rest }
