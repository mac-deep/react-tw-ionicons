...
export default function Football({ extraStyles, extraClasses, ...rest }: FootballProps) {
  const defaultProps: FootballProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FootballProps = { ...defaultProps, ...rest }
