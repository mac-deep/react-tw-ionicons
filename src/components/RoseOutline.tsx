...
type RoseOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function RoseOutline({ extraStyles, extraClasses, ...rest }: RoseOutlineProps) {
  const defaultProps: RoseOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: RoseOutlineProps = { ...defaultProps, ...rest }
