...
export default function LogoSkype({ extraStyles, extraClasses, ...rest }: LogoSkypeProps) {
  const defaultProps: LogoSkypeProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoSkypeProps = { ...defaultProps, ...rest }
