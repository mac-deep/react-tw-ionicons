...
export default function PersonCircle({ extraStyles, extraClasses, ...rest }: PersonCircleProps) {
  const defaultProps: PersonCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PersonCircleProps = { ...defaultProps, ...rest }
