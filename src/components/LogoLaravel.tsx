...
type LogoLaravelProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoLaravel({ extraStyles, extraClasses, ...rest }: LogoLaravelProps) {
  const defaultProps: LogoLaravelProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoLaravelProps = { ...defaultProps, ...rest }
