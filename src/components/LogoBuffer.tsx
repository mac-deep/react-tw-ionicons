...
type LogoBufferProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoBuffer({ extraStyles, extraClasses, ...rest }: LogoBufferProps) {
  const defaultProps: LogoBufferProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoBufferProps = { ...defaultProps, ...rest }
