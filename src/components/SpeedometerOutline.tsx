...
type SpeedometerOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SpeedometerOutline({ extraStyles, extraClasses, ...rest }: SpeedometerOutlineProps) {
  const defaultProps: SpeedometerOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SpeedometerOutlineProps = { ...defaultProps, ...rest }
