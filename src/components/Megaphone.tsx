...
export default function Megaphone({ extraStyles, extraClasses, ...rest }: MegaphoneProps) {
  const defaultProps: MegaphoneProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MegaphoneProps = { ...defaultProps, ...rest }
