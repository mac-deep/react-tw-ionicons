...
type LibrarySharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LibrarySharp({ extraStyles, extraClasses, ...rest }: LibrarySharpProps) {
  const defaultProps: LibrarySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LibrarySharpProps = { ...defaultProps, ...rest }
