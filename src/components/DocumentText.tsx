...
export default function DocumentText({ extraStyles, extraClasses, ...rest }: DocumentTextProps) {
  const defaultProps: DocumentTextProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DocumentTextProps = { ...defaultProps, ...rest }
