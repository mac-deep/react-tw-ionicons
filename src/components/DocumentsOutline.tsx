...
type DocumentsOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function DocumentsOutline({ extraStyles, extraClasses, ...rest }: DocumentsOutlineProps) {
  const defaultProps: DocumentsOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DocumentsOutlineProps = { ...defaultProps, ...rest }
