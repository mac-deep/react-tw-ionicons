...
type LogoBitbucketProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoBitbucket({ extraStyles, extraClasses, ...rest }: LogoBitbucketProps) {
  const defaultProps: LogoBitbucketProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoBitbucketProps = { ...defaultProps, ...rest }
