...
type LogoAppleArProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoAppleAr({ extraStyles, extraClasses, ...rest }: LogoAppleArProps) {
  const defaultProps: LogoAppleArProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoAppleArProps = { ...defaultProps, ...rest }
