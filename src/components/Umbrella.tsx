...
export default function Umbrella({ extraStyles, extraClasses, ...rest }: UmbrellaProps) {
  const defaultProps: UmbrellaProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: UmbrellaProps = { ...defaultProps, ...rest }
