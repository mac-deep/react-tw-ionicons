...
export default function BulbSharp({ extraStyles, extraClasses, ...rest }: BulbSharpProps) {
  const defaultProps: BulbSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BulbSharpProps = { ...defaultProps, ...rest }
