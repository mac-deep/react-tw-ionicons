...
type BoatOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BoatOutline({ extraStyles, extraClasses, ...rest }: BoatOutlineProps) {
  const defaultProps: BoatOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BoatOutlineProps = { ...defaultProps, ...rest }
