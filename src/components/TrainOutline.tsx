...
type TrainOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TrainOutline({ extraStyles, extraClasses, ...rest }: TrainOutlineProps) {
  const defaultProps: TrainOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TrainOutlineProps = { ...defaultProps, ...rest }
