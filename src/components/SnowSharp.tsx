...
export default function SnowSharp({ extraStyles, extraClasses, ...rest }: SnowSharpProps) {
  const defaultProps: SnowSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SnowSharpProps = { ...defaultProps, ...rest }
