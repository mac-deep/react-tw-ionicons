...
export default function CloudDone({ extraStyles, extraClasses, ...rest }: CloudDoneProps) {
  const defaultProps: CloudDoneProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudDoneProps = { ...defaultProps, ...rest }
