...
export default function PersonAdd({ extraStyles, extraClasses, ...rest }: PersonAddProps) {
  const defaultProps: PersonAddProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PersonAddProps = { ...defaultProps, ...rest }
