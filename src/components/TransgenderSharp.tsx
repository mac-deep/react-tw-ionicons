...
type TransgenderSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TransgenderSharp({ extraStyles, extraClasses, ...rest }: TransgenderSharpProps) {
  const defaultProps: TransgenderSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TransgenderSharpProps = { ...defaultProps, ...rest }
