...
type SyncOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SyncOutline({ extraStyles, extraClasses, ...rest }: SyncOutlineProps) {
  const defaultProps: SyncOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SyncOutlineProps = { ...defaultProps, ...rest }
