...
export default function BagCheck({ extraStyles, extraClasses, ...rest }: BagCheckProps) {
  const defaultProps: BagCheckProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BagCheckProps = { ...defaultProps, ...rest }
