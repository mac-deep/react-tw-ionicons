...
export default function MaleSharp({ extraStyles, extraClasses, ...rest }: MaleSharpProps) {
  const defaultProps: MaleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MaleSharpProps = { ...defaultProps, ...rest }
