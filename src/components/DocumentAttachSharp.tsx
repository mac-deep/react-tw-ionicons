...
type DocumentAttachSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function DocumentAttachSharp({ extraStyles, extraClasses, ...rest }: DocumentAttachSharpProps) {
  const defaultProps: DocumentAttachSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DocumentAttachSharpProps = { ...defaultProps, ...rest }
