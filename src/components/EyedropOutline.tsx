...
type EyedropOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function EyedropOutline({ extraStyles, extraClasses, ...rest }: EyedropOutlineProps) {
  const defaultProps: EyedropOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EyedropOutlineProps = { ...defaultProps, ...rest }
