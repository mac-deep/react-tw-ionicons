...
type SunnySharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SunnySharp({ extraStyles, extraClasses, ...rest }: SunnySharpProps) {
  const defaultProps: SunnySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SunnySharpProps = { ...defaultProps, ...rest }
