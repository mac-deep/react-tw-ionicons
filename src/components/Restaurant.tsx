...
export default function Restaurant({ extraStyles, extraClasses, ...rest }: RestaurantProps) {
  const defaultProps: RestaurantProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: RestaurantProps = { ...defaultProps, ...rest }
