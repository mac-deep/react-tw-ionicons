...
export default function Pricetags({ extraStyles, extraClasses, ...rest }: PricetagsProps) {
  const defaultProps: PricetagsProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PricetagsProps = { ...defaultProps, ...rest }
