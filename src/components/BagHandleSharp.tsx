...
type BagHandleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BagHandleSharp({ extraStyles, extraClasses, ...rest }: BagHandleSharpProps) {
  const defaultProps: BagHandleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BagHandleSharpProps = { ...defaultProps, ...rest }
