...
export default function LogoPwa({ extraStyles, extraClasses, ...rest }: LogoPwaProps) {
  const defaultProps: LogoPwaProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoPwaProps = { ...defaultProps, ...rest }
