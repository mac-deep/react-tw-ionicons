...
export default function FlagSharp({ extraStyles, extraClasses, ...rest }: FlagSharpProps) {
  const defaultProps: FlagSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlagSharpProps = { ...defaultProps, ...rest }
