...
export default function Footsteps({ extraStyles, extraClasses, ...rest }: FootstepsProps) {
  const defaultProps: FootstepsProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FootstepsProps = { ...defaultProps, ...rest }
