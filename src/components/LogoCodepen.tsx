...
type LogoCodepenProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoCodepen({ extraStyles, extraClasses, ...rest }: LogoCodepenProps) {
  const defaultProps: LogoCodepenProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoCodepenProps = { ...defaultProps, ...rest }
