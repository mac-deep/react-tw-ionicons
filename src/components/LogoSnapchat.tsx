...
type LogoSnapchatProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoSnapchat({ extraStyles, extraClasses, ...rest }: LogoSnapchatProps) {
  const defaultProps: LogoSnapchatProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoSnapchatProps = { ...defaultProps, ...rest }
