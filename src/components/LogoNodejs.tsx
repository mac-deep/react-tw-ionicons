...
type LogoNodejsProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoNodejs({ extraStyles, extraClasses, ...rest }: LogoNodejsProps) {
  const defaultProps: LogoNodejsProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoNodejsProps = { ...defaultProps, ...rest }
