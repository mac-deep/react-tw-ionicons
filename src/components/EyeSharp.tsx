...
export default function EyeSharp({ extraStyles, extraClasses, ...rest }: EyeSharpProps) {
  const defaultProps: EyeSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EyeSharpProps = { ...defaultProps, ...rest }
