...
type MicOffCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MicOffCircleSharp({ extraStyles, extraClasses, ...rest }: MicOffCircleSharpProps) {
  const defaultProps: MicOffCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MicOffCircleSharpProps = { ...defaultProps, ...rest }
