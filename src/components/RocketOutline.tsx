...
type RocketOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function RocketOutline({ extraStyles, extraClasses, ...rest }: RocketOutlineProps) {
  const defaultProps: RocketOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: RocketOutlineProps = { ...defaultProps, ...rest }
