...
type ThumbsUpOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ThumbsUpOutline({ extraStyles, extraClasses, ...rest }: ThumbsUpOutlineProps) {
  const defaultProps: ThumbsUpOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThumbsUpOutlineProps = { ...defaultProps, ...rest }
