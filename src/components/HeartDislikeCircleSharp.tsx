...
type HeartDislikeCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartDislikeCircleSharp({ extraStyles, extraClasses, ...rest }: HeartDislikeCircleSharpProps) {
  const defaultProps: HeartDislikeCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartDislikeCircleSharpProps = { ...defaultProps, ...rest }
