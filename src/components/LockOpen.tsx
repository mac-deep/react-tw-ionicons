...
export default function LockOpen({ extraStyles, extraClasses, ...rest }: LockOpenProps) {
  const defaultProps: LockOpenProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LockOpenProps = { ...defaultProps, ...rest }
