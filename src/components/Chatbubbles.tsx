...
export default function Chatbubbles({ extraStyles, extraClasses, ...rest }: ChatbubblesProps) {
  const defaultProps: ChatbubblesProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ChatbubblesProps = { ...defaultProps, ...rest }
