...
export default function ColorFilter({ extraStyles, extraClasses, ...rest }: ColorFilterProps) {
  const defaultProps: ColorFilterProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ColorFilterProps = { ...defaultProps, ...rest }
