...
type GitPullRequestSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function GitPullRequestSharp({ extraStyles, extraClasses, ...rest }: GitPullRequestSharpProps) {
  const defaultProps: GitPullRequestSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GitPullRequestSharpProps = { ...defaultProps, ...rest }
