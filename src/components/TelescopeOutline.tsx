...
type TelescopeOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TelescopeOutline({ extraStyles, extraClasses, ...rest }: TelescopeOutlineProps) {
  const defaultProps: TelescopeOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TelescopeOutlineProps = { ...defaultProps, ...rest }
