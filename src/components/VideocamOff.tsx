...
type VideocamOffProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VideocamOff({ extraStyles, extraClasses, ...rest }: VideocamOffProps) {
  const defaultProps: VideocamOffProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VideocamOffProps = { ...defaultProps, ...rest }
