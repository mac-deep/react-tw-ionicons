...
type WalletSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function WalletSharp({ extraStyles, extraClasses, ...rest }: WalletSharpProps) {
  const defaultProps: WalletSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: WalletSharpProps = { ...defaultProps, ...rest }
