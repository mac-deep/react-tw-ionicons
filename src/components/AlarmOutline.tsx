...
type AlarmOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AlarmOutline({ extraStyles, extraClasses, ...rest }: AlarmOutlineProps) {
  const defaultProps: AlarmOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AlarmOutlineProps = { ...defaultProps, ...rest }
