...
type NotificationsOffCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NotificationsOffCircle({ extraStyles, extraClasses, ...rest }: NotificationsOffCircleProps) {
  const defaultProps: NotificationsOffCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NotificationsOffCircleProps = { ...defaultProps, ...rest }
