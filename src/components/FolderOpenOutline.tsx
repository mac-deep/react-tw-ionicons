...
type FolderOpenOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FolderOpenOutline({ extraStyles, extraClasses, ...rest }: FolderOpenOutlineProps) {
  const defaultProps: FolderOpenOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FolderOpenOutlineProps = { ...defaultProps, ...rest }
