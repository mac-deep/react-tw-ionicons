...
type HammerSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HammerSharp({ extraStyles, extraClasses, ...rest }: HammerSharpProps) {
  const defaultProps: HammerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HammerSharpProps = { ...defaultProps, ...rest }
