...
type IceCreamSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function IceCreamSharp({ extraStyles, extraClasses, ...rest }: IceCreamSharpProps) {
  const defaultProps: IceCreamSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: IceCreamSharpProps = { ...defaultProps, ...rest }
