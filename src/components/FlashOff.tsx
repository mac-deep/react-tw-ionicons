...
export default function FlashOff({ extraStyles, extraClasses, ...rest }: FlashOffProps) {
  const defaultProps: FlashOffProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlashOffProps = { ...defaultProps, ...rest }
