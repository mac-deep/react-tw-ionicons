...
export default function CallOutline({ extraStyles, extraClasses, ...rest }: CallOutlineProps) {
  const defaultProps: CallOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CallOutlineProps = { ...defaultProps, ...rest }
