...
type ScanCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ScanCircle({ extraStyles, extraClasses, ...rest }: ScanCircleProps) {
  const defaultProps: ScanCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ScanCircleProps = { ...defaultProps, ...rest }
