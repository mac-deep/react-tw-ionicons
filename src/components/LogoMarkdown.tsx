...
type LogoMarkdownProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoMarkdown({ extraStyles, extraClasses, ...rest }: LogoMarkdownProps) {
  const defaultProps: LogoMarkdownProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoMarkdownProps = { ...defaultProps, ...rest }
