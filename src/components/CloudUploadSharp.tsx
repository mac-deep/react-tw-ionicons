...
type CloudUploadSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudUploadSharp({ extraStyles, extraClasses, ...rest }: CloudUploadSharpProps) {
  const defaultProps: CloudUploadSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudUploadSharpProps = { ...defaultProps, ...rest }
