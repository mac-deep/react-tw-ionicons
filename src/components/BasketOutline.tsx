...
type BasketOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BasketOutline({ extraStyles, extraClasses, ...rest }: BasketOutlineProps) {
  const defaultProps: BasketOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BasketOutlineProps = { ...defaultProps, ...rest }
