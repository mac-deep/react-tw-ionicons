...
type LogoPlaystationProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoPlaystation({ extraStyles, extraClasses, ...rest }: LogoPlaystationProps) {
  const defaultProps: LogoPlaystationProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoPlaystationProps = { ...defaultProps, ...rest }
