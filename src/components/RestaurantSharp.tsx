...
type RestaurantSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function RestaurantSharp({ extraStyles, extraClasses, ...rest }: RestaurantSharpProps) {
  const defaultProps: RestaurantSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: RestaurantSharpProps = { ...defaultProps, ...rest }
