...
type HeartHalfOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartHalfOutline({ extraStyles, extraClasses, ...rest }: HeartHalfOutlineProps) {
  const defaultProps: HeartHalfOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartHalfOutlineProps = { ...defaultProps, ...rest }
