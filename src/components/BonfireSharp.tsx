...
type BonfireSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BonfireSharp({ extraStyles, extraClasses, ...rest }: BonfireSharpProps) {
  const defaultProps: BonfireSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BonfireSharpProps = { ...defaultProps, ...rest }
