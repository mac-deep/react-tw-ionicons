...
type LayersOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LayersOutline({ extraStyles, extraClasses, ...rest }: LayersOutlineProps) {
  const defaultProps: LayersOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LayersOutlineProps = { ...defaultProps, ...rest }
