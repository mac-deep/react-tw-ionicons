...
export default function CheckmarkCircle({ extraStyles, extraClasses, ...rest }: CheckmarkCircleProps) {
  const defaultProps: CheckmarkCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CheckmarkCircleProps = { ...defaultProps, ...rest }
