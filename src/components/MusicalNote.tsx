...
export default function MusicalNote({ extraStyles, extraClasses, ...rest }: MusicalNoteProps) {
  const defaultProps: MusicalNoteProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MusicalNoteProps = { ...defaultProps, ...rest }
