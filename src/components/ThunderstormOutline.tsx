...
type ThunderstormOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ThunderstormOutline({ extraStyles, extraClasses, ...rest }: ThunderstormOutlineProps) {
  const defaultProps: ThunderstormOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThunderstormOutlineProps = { ...defaultProps, ...rest }
