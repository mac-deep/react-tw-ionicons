...
type LogoPaypalProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoPaypal({ extraStyles, extraClasses, ...rest }: LogoPaypalProps) {
  const defaultProps: LogoPaypalProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoPaypalProps = { ...defaultProps, ...rest }
