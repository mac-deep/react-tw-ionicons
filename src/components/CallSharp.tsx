...
export default function CallSharp({ extraStyles, extraClasses, ...rest }: CallSharpProps) {
  const defaultProps: CallSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CallSharpProps = { ...defaultProps, ...rest }
