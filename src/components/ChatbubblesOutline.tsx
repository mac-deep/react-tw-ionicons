...
type ChatbubblesOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ChatbubblesOutline({ extraStyles, extraClasses, ...rest }: ChatbubblesOutlineProps) {
  const defaultProps: ChatbubblesOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ChatbubblesOutlineProps = { ...defaultProps, ...rest }
