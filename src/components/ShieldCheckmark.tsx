...
type ShieldCheckmarkProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ShieldCheckmark({ extraStyles, extraClasses, ...rest }: ShieldCheckmarkProps) {
  const defaultProps: ShieldCheckmarkProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ShieldCheckmarkProps = { ...defaultProps, ...rest }
