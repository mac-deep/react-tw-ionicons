...
type HeadsetOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeadsetOutline({ extraStyles, extraClasses, ...rest }: HeadsetOutlineProps) {
  const defaultProps: HeadsetOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeadsetOutlineProps = { ...defaultProps, ...rest }
