...
type BagAddSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BagAddSharp({ extraStyles, extraClasses, ...rest }: BagAddSharpProps) {
  const defaultProps: BagAddSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BagAddSharpProps = { ...defaultProps, ...rest }
