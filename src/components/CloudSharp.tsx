...
type CloudSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudSharp({ extraStyles, extraClasses, ...rest }: CloudSharpProps) {
  const defaultProps: CloudSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudSharpProps = { ...defaultProps, ...rest }
