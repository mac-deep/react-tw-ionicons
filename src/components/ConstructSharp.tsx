...
type ConstructSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ConstructSharp({ extraStyles, extraClasses, ...rest }: ConstructSharpProps) {
  const defaultProps: ConstructSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ConstructSharpProps = { ...defaultProps, ...rest }
