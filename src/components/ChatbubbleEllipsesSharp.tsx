...
type ChatbubbleEllipsesSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ChatbubbleEllipsesSharp({ extraStyles, extraClasses, ...rest }: ChatbubbleEllipsesSharpProps) {
  const defaultProps: ChatbubbleEllipsesSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ChatbubbleEllipsesSharpProps = { ...defaultProps, ...rest }
