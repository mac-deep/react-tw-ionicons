...
export default function Construct({ extraStyles, extraClasses, ...rest }: ConstructProps) {
  const defaultProps: ConstructProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ConstructProps = { ...defaultProps, ...rest }
