...
type FileTrayFullProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FileTrayFull({ extraStyles, extraClasses, ...rest }: FileTrayFullProps) {
  const defaultProps: FileTrayFullProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FileTrayFullProps = { ...defaultProps, ...rest }
