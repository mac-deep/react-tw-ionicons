...
type GitCompareProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function GitCompare({ extraStyles, extraClasses, ...rest }: GitCompareProps) {
  const defaultProps: GitCompareProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GitCompareProps = { ...defaultProps, ...rest }
