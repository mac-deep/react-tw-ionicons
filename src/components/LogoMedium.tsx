...
type LogoMediumProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoMedium({ extraStyles, extraClasses, ...rest }: LogoMediumProps) {
  const defaultProps: LogoMediumProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoMediumProps = { ...defaultProps, ...rest }
