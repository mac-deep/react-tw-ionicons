...
type LogoMastodonProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoMastodon({ extraStyles, extraClasses, ...rest }: LogoMastodonProps) {
  const defaultProps: LogoMastodonProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoMastodonProps = { ...defaultProps, ...rest }
