...
export default function LeafSharp({ extraStyles, extraClasses, ...rest }: LeafSharpProps) {
  const defaultProps: LeafSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LeafSharpProps = { ...defaultProps, ...rest }
