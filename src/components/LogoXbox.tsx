...
export default function LogoXbox({ extraStyles, extraClasses, ...rest }: LogoXboxProps) {
  const defaultProps: LogoXboxProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoXboxProps = { ...defaultProps, ...rest }
