...
type FlagOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FlagOutline({ extraStyles, extraClasses, ...rest }: FlagOutlineProps) {
  const defaultProps: FlagOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlagOutlineProps = { ...defaultProps, ...rest }
