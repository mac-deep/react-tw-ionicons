...
type HeartDislikeProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartDislike({ extraStyles, extraClasses, ...rest }: HeartDislikeProps) {
  const defaultProps: HeartDislikeProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartDislikeProps = { ...defaultProps, ...rest }
