...
type PeopleCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PeopleCircleSharp({ extraStyles, extraClasses, ...rest }: PeopleCircleSharpProps) {
  const defaultProps: PeopleCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PeopleCircleSharpProps = { ...defaultProps, ...rest }
