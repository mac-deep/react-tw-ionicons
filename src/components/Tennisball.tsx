...
export default function Tennisball({ extraStyles, extraClasses, ...rest }: TennisballProps) {
  const defaultProps: TennisballProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TennisballProps = { ...defaultProps, ...rest }
