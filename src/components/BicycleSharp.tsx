...
type BicycleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BicycleSharp({ extraStyles, extraClasses, ...rest }: BicycleSharpProps) {
  const defaultProps: BicycleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BicycleSharpProps = { ...defaultProps, ...rest }
