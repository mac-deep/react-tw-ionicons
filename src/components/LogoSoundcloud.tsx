...
type LogoSoundcloudProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoSoundcloud({ extraStyles, extraClasses, ...rest }: LogoSoundcloudProps) {
  const defaultProps: LogoSoundcloudProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoSoundcloudProps = { ...defaultProps, ...rest }
