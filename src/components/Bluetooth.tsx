...
export default function Bluetooth({ extraStyles, extraClasses, ...rest }: BluetoothProps) {
  const defaultProps: BluetoothProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BluetoothProps = { ...defaultProps, ...rest }
