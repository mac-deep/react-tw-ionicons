...
type ConstructOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ConstructOutline({ extraStyles, extraClasses, ...rest }: ConstructOutlineProps) {
  const defaultProps: ConstructOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ConstructOutlineProps = { ...defaultProps, ...rest }
