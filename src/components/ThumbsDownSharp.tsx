...
type ThumbsDownSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ThumbsDownSharp({ extraStyles, extraClasses, ...rest }: ThumbsDownSharpProps) {
  const defaultProps: ThumbsDownSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThumbsDownSharpProps = { ...defaultProps, ...rest }
