...
export default function SettingsOutline({ extraStyles, extraClasses, ...rest }: SettingsOutlineProps) {
  const defaultProps: SettingsOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SettingsOutlineProps = { ...defaultProps, ...rest }
