...
export default function Bandage({ extraStyles, extraClasses, ...rest }: BandageProps) {
  const defaultProps: BandageProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BandageProps = { ...defaultProps, ...rest }
