...
type EyedropSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function EyedropSharp({ extraStyles, extraClasses, ...rest }: EyedropSharpProps) {
  const defaultProps: EyedropSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EyedropSharpProps = { ...defaultProps, ...rest }
