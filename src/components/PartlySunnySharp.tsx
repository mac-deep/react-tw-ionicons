...
type PartlySunnySharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PartlySunnySharp({ extraStyles, extraClasses, ...rest }: PartlySunnySharpProps) {
  const defaultProps: PartlySunnySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PartlySunnySharpProps = { ...defaultProps, ...rest }
