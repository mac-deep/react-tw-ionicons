...
type PeopleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PeopleSharp({ extraStyles, extraClasses, ...rest }: PeopleSharpProps) {
  const defaultProps: PeopleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PeopleSharpProps = { ...defaultProps, ...rest }
