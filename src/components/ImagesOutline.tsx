...
type ImagesOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ImagesOutline({ extraStyles, extraClasses, ...rest }: ImagesOutlineProps) {
  const defaultProps: ImagesOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ImagesOutlineProps = { ...defaultProps, ...rest }
