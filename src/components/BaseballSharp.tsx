...
type BaseballSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BaseballSharp({ extraStyles, extraClasses, ...rest }: BaseballSharpProps) {
  const defaultProps: BaseballSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BaseballSharpProps = { ...defaultProps, ...rest }
