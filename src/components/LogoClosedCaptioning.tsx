...
type LogoClosedCaptioningProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoClosedCaptioning({ extraStyles, extraClasses, ...rest }: LogoClosedCaptioningProps) {
  const defaultProps: LogoClosedCaptioningProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoClosedCaptioningProps = { ...defaultProps, ...rest }
