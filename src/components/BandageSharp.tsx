...
type BandageSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BandageSharp({ extraStyles, extraClasses, ...rest }: BandageSharpProps) {
  const defaultProps: BandageSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BandageSharpProps = { ...defaultProps, ...rest }
