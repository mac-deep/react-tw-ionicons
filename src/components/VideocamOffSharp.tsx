...
type VideocamOffSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VideocamOffSharp({ extraStyles, extraClasses, ...rest }: VideocamOffSharpProps) {
  const defaultProps: VideocamOffSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VideocamOffSharpProps = { ...defaultProps, ...rest }
