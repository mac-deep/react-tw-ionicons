...
export default function Backspace({ extraStyles, extraClasses, ...rest }: BackspaceProps) {
  const defaultProps: BackspaceProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BackspaceProps = { ...defaultProps, ...rest }
