...
export default function Documents({ extraStyles, extraClasses, ...rest }: DocumentsProps) {
  const defaultProps: DocumentsProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DocumentsProps = { ...defaultProps, ...rest }
