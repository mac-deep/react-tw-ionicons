...
type AtCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AtCircleSharp({ extraStyles, extraClasses, ...rest }: AtCircleSharpProps) {
  const defaultProps: AtCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AtCircleSharpProps = { ...defaultProps, ...rest }
