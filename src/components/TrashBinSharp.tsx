...
type TrashBinSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TrashBinSharp({ extraStyles, extraClasses, ...rest }: TrashBinSharpProps) {
  const defaultProps: TrashBinSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TrashBinSharpProps = { ...defaultProps, ...rest }
