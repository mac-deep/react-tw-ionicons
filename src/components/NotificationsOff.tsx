...
type NotificationsOffProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NotificationsOff({ extraStyles, extraClasses, ...rest }: NotificationsOffProps) {
  const defaultProps: NotificationsOffProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NotificationsOffProps = { ...defaultProps, ...rest }
