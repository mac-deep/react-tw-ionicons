...
type TrophySharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TrophySharp({ extraStyles, extraClasses, ...rest }: TrophySharpProps) {
  const defaultProps: TrophySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TrophySharpProps = { ...defaultProps, ...rest }
