...
type ArrowUndoCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ArrowUndoCircle({ extraStyles, extraClasses, ...rest }: ArrowUndoCircleProps) {
  const defaultProps: ArrowUndoCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ArrowUndoCircleProps = { ...defaultProps, ...rest }
