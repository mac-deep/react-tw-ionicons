...
export default function FileTray({ extraStyles, extraClasses, ...rest }: FileTrayProps) {
  const defaultProps: FileTrayProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FileTrayProps = { ...defaultProps, ...rest }
