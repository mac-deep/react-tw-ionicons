...
type PersonRemoveProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PersonRemove({ extraStyles, extraClasses, ...rest }: PersonRemoveProps) {
  const defaultProps: PersonRemoveProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PersonRemoveProps = { ...defaultProps, ...rest }
