...
export default function Thermometer({ extraStyles, extraClasses, ...rest }: ThermometerProps) {
  const defaultProps: ThermometerProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThermometerProps = { ...defaultProps, ...rest }
