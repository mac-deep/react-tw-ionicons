...
export default function DocumentAttach({ extraStyles, extraClasses, ...rest }: DocumentAttachProps) {
  const defaultProps: DocumentAttachProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DocumentAttachProps = { ...defaultProps, ...rest }
