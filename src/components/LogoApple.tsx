...
export default function LogoApple({ extraStyles, extraClasses, ...rest }: LogoAppleProps) {
  const defaultProps: LogoAppleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoAppleProps = { ...defaultProps, ...rest }
