...
type CloudDownloadSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudDownloadSharp({ extraStyles, extraClasses, ...rest }: CloudDownloadSharpProps) {
  const defaultProps: CloudDownloadSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudDownloadSharpProps = { ...defaultProps, ...rest }
