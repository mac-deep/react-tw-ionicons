...
type NotificationsOffOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NotificationsOffOutline({ extraStyles, extraClasses, ...rest }: NotificationsOffOutlineProps) {
  const defaultProps: NotificationsOffOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NotificationsOffOutlineProps = { ...defaultProps, ...rest }
