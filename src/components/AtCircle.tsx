...
export default function AtCircle({ extraStyles, extraClasses, ...rest }: AtCircleProps) {
  const defaultProps: AtCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AtCircleProps = { ...defaultProps, ...rest }
