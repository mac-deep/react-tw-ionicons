...
export default function Bookmarks({ extraStyles, extraClasses, ...rest }: BookmarksProps) {
  const defaultProps: BookmarksProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BookmarksProps = { ...defaultProps, ...rest }
