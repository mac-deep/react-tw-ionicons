...
type VolumeHighOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VolumeHighOutline({ extraStyles, extraClasses, ...rest }: VolumeHighOutlineProps) {
  const defaultProps: VolumeHighOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VolumeHighOutlineProps = { ...defaultProps, ...rest }
