...
type MusicalNotesProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MusicalNotes({ extraStyles, extraClasses, ...rest }: MusicalNotesProps) {
  const defaultProps: MusicalNotesProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MusicalNotesProps = { ...defaultProps, ...rest }
