...
type CloudyNightSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudyNightSharp({ extraStyles, extraClasses, ...rest }: CloudyNightSharpProps) {
  const defaultProps: CloudyNightSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudyNightSharpProps = { ...defaultProps, ...rest }
