...
export default function Walk({ extraStyles, extraClasses, ...rest }: WalkProps) {
  const defaultProps: WalkProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: WalkProps = { ...defaultProps, ...rest }
    ...
    <>
      ...
      >
        ...
        <circle
          ...
          cy="69.56"
          r="37.04"
          style={{ stroke: 'currentColor', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '16px' }}
        />
      </svg>
    </>
  )
