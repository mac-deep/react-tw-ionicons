...
type HeadsetSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeadsetSharp({ extraStyles, extraClasses, ...rest }: HeadsetSharpProps) {
  const defaultProps: HeadsetSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeadsetSharpProps = { ...defaultProps, ...rest }
