...
type FlameSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FlameSharp({ extraStyles, extraClasses, ...rest }: FlameSharpProps) {
  const defaultProps: FlameSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlameSharpProps = { ...defaultProps, ...rest }
