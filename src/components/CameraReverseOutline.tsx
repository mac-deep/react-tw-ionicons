...
type CameraReverseOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CameraReverseOutline({ extraStyles, extraClasses, ...rest }: CameraReverseOutlineProps) {
  const defaultProps: CameraReverseOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CameraReverseOutlineProps = { ...defaultProps, ...rest }
