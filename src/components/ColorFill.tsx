...
export default function ColorFill({ extraStyles, extraClasses, ...rest }: ColorFillProps) {
  const defaultProps: ColorFillProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ColorFillProps = { ...defaultProps, ...rest }
