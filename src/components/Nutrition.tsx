...
export default function Nutrition({ extraStyles, extraClasses, ...rest }: NutritionProps) {
  const defaultProps: NutritionProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NutritionProps = { ...defaultProps, ...rest }
