...
export default function FileTrayStacked({ extraStyles, extraClasses, ...rest }: FileTrayStackedProps) {
  const defaultProps: FileTrayStackedProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FileTrayStackedProps = { ...defaultProps, ...rest }
