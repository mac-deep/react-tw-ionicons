...
type ColorFilterSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ColorFilterSharp({ extraStyles, extraClasses, ...rest }: ColorFilterSharpProps) {
  const defaultProps: ColorFilterSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ColorFilterSharpProps = { ...defaultProps, ...rest }
