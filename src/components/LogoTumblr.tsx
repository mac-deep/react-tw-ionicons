...
type LogoTumblrProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoTumblr({ extraStyles, extraClasses, ...rest }: LogoTumblrProps) {
  const defaultProps: LogoTumblrProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoTumblrProps = { ...defaultProps, ...rest }
