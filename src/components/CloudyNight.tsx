...
type CloudyNightProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudyNight({ extraStyles, extraClasses, ...rest }: CloudyNightProps) {
  const defaultProps: CloudyNightProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudyNightProps = { ...defaultProps, ...rest }
