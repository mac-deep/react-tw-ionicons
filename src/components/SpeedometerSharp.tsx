...
type SpeedometerSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SpeedometerSharp({ extraStyles, extraClasses, ...rest }: SpeedometerSharpProps) {
  const defaultProps: SpeedometerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SpeedometerSharpProps = { ...defaultProps, ...rest }
