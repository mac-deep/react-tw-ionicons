...
export default function ThumbsDown({ extraStyles, extraClasses, ...rest }: ThumbsDownProps) {
  const defaultProps: ThumbsDownProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThumbsDownProps = { ...defaultProps, ...rest }
