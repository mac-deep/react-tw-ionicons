...
export default function Shuffle({ extraStyles, extraClasses, ...rest }: ShuffleProps) {
  const defaultProps: ShuffleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ShuffleProps = { ...defaultProps, ...rest }
