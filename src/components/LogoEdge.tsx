...
export default function LogoEdge({ extraStyles, extraClasses, ...rest }: LogoEdgeProps) {
  const defaultProps: LogoEdgeProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoEdgeProps = { ...defaultProps, ...rest }
