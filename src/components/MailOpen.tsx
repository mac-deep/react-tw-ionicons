...
export default function MailOpen({ extraStyles, extraClasses, ...rest }: MailOpenProps) {
  const defaultProps: MailOpenProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MailOpenProps = { ...defaultProps, ...rest }
