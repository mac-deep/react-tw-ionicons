...
type LogoFirefoxProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoFirefox({ extraStyles, extraClasses, ...rest }: LogoFirefoxProps) {
  const defaultProps: LogoFirefoxProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoFirefoxProps = { ...defaultProps, ...rest }
