...
type SettingsSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SettingsSharp({ extraStyles, extraClasses, ...rest }: SettingsSharpProps) {
  const defaultProps: SettingsSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SettingsSharpProps = { ...defaultProps, ...rest }
