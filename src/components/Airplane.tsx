...
export default function Airplane({ extraStyles, extraClasses, ...rest }: AirplaneProps) {
  const defaultProps: AirplaneProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AirplaneProps = { ...defaultProps, ...rest }
