...
export default function CafeSharp({ extraStyles, extraClasses, ...rest }: CafeSharpProps) {
  const defaultProps: CafeSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CafeSharpProps = { ...defaultProps, ...rest }
