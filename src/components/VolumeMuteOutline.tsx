...
type VolumeMuteOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VolumeMuteOutline({ extraStyles, extraClasses, ...rest }: VolumeMuteOutlineProps) {
  const defaultProps: VolumeMuteOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VolumeMuteOutlineProps = { ...defaultProps, ...rest }
