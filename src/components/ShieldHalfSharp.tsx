...
type ShieldHalfSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ShieldHalfSharp({ extraStyles, extraClasses, ...rest }: ShieldHalfSharpProps) {
  const defaultProps: ShieldHalfSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ShieldHalfSharpProps = { ...defaultProps, ...rest }
