...
type TelescopeSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TelescopeSharp({ extraStyles, extraClasses, ...rest }: TelescopeSharpProps) {
  const defaultProps: TelescopeSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TelescopeSharpProps = { ...defaultProps, ...rest }
