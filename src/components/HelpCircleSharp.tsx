...
type HelpCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HelpCircleSharp({ extraStyles, extraClasses, ...rest }: HelpCircleSharpProps) {
  const defaultProps: HelpCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HelpCircleSharpProps = { ...defaultProps, ...rest }
