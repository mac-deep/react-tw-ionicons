...
type BalloonSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BalloonSharp({ extraStyles, extraClasses, ...rest }: BalloonSharpProps) {
  const defaultProps: BalloonSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BalloonSharpProps = { ...defaultProps, ...rest }
