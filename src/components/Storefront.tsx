...
export default function Storefront({ extraStyles, extraClasses, ...rest }: StorefrontProps) {
  const defaultProps: StorefrontProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: StorefrontProps = { ...defaultProps, ...rest }
