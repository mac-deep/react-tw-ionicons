...
type CloudOfflineSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudOfflineSharp({ extraStyles, extraClasses, ...rest }: CloudOfflineSharpProps) {
  const defaultProps: CloudOfflineSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudOfflineSharpProps = { ...defaultProps, ...rest }
