...
type LogoElectronProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoElectron({ extraStyles, extraClasses, ...rest }: LogoElectronProps) {
  const defaultProps: LogoElectronProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoElectronProps = { ...defaultProps, ...rest }
