...
export default function PaperPlane({ extraStyles, extraClasses, ...rest }: PaperPlaneProps) {
  const defaultProps: PaperPlaneProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PaperPlaneProps = { ...defaultProps, ...rest }
