...
type CameraReverseSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CameraReverseSharp({ extraStyles, extraClasses, ...rest }: CameraReverseSharpProps) {
  const defaultProps: CameraReverseSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CameraReverseSharpProps = { ...defaultProps, ...rest }
