...
type PizzaSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PizzaSharp({ extraStyles, extraClasses, ...rest }: PizzaSharpProps) {
  const defaultProps: PizzaSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PizzaSharpProps = { ...defaultProps, ...rest }
