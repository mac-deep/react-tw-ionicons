...
type UmbrellaSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function UmbrellaSharp({ extraStyles, extraClasses, ...rest }: UmbrellaSharpProps) {
  const defaultProps: UmbrellaSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: UmbrellaSharpProps = { ...defaultProps, ...rest }
