...
type NewspaperOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NewspaperOutline({ extraStyles, extraClasses, ...rest }: NewspaperOutlineProps) {
  const defaultProps: NewspaperOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NewspaperOutlineProps = { ...defaultProps, ...rest }
