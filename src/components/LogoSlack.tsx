...
export default function LogoSlack({ extraStyles, extraClasses, ...rest }: LogoSlackProps) {
  const defaultProps: LogoSlackProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoSlackProps = { ...defaultProps, ...rest }
