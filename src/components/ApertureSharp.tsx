...
type ApertureSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ApertureSharp({ extraStyles, extraClasses, ...rest }: ApertureSharpProps) {
  const defaultProps: ApertureSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ApertureSharpProps = { ...defaultProps, ...rest }
