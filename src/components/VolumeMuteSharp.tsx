...
type VolumeMuteSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VolumeMuteSharp({ extraStyles, extraClasses, ...rest }: VolumeMuteSharpProps) {
  const defaultProps: VolumeMuteSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VolumeMuteSharpProps = { ...defaultProps, ...rest }
