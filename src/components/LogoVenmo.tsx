...
export default function LogoVenmo({ extraStyles, extraClasses, ...rest }: LogoVenmoProps) {
  const defaultProps: LogoVenmoProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoVenmoProps = { ...defaultProps, ...rest }
