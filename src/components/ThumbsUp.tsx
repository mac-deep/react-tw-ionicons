...
export default function ThumbsUp({ extraStyles, extraClasses, ...rest }: ThumbsUpProps) {
  const defaultProps: ThumbsUpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThumbsUpProps = { ...defaultProps, ...rest }
