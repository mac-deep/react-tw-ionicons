...
export default function BugSharp({ extraStyles, extraClasses, ...rest }: BugSharpProps) {
  const defaultProps: BugSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BugSharpProps = { ...defaultProps, ...rest }
