...
export default function CashSharp({ extraStyles, extraClasses, ...rest }: CashSharpProps) {
  const defaultProps: CashSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CashSharpProps = { ...defaultProps, ...rest }
