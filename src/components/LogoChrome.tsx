...
type LogoChromeProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoChrome({ extraStyles, extraClasses, ...rest }: LogoChromeProps) {
  const defaultProps: LogoChromeProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoChromeProps = { ...defaultProps, ...rest }
