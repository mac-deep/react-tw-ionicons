...
type ShieldCheckmarkSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ShieldCheckmarkSharp({ extraStyles, extraClasses, ...rest }: ShieldCheckmarkSharpProps) {
  const defaultProps: ShieldCheckmarkSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ShieldCheckmarkSharpProps = { ...defaultProps, ...rest }
