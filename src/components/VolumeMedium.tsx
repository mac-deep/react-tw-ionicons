...
type VolumeMediumProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VolumeMedium({ extraStyles, extraClasses, ...rest }: VolumeMediumProps) {
  const defaultProps: VolumeMediumProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VolumeMediumProps = { ...defaultProps, ...rest }
