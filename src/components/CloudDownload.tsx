...
export default function CloudDownload({ extraStyles, extraClasses, ...rest }: CloudDownloadProps) {
  const defaultProps: CloudDownloadProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudDownloadProps = { ...defaultProps, ...rest }
