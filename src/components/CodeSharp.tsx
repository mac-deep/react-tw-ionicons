...
export default function CodeSharp({ extraStyles, extraClasses, ...rest }: CodeSharpProps) {
  const defaultProps: CodeSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CodeSharpProps = { ...defaultProps, ...rest }
