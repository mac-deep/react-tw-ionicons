...
type ReloadCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ReloadCircle({ extraStyles, extraClasses, ...rest }: ReloadCircleProps) {
  const defaultProps: ReloadCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ReloadCircleProps = { ...defaultProps, ...rest }
