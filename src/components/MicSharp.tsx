...
export default function MicSharp({ extraStyles, extraClasses, ...rest }: MicSharpProps) {
  const defaultProps: MicSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MicSharpProps = { ...defaultProps, ...rest }
