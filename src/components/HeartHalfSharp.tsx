...
type HeartHalfSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartHalfSharp({ extraStyles, extraClasses, ...rest }: HeartHalfSharpProps) {
  const defaultProps: HeartHalfSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartHalfSharpProps = { ...defaultProps, ...rest }
