...
type CreateOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CreateOutline({ extraStyles, extraClasses, ...rest }: CreateOutlineProps) {
  const defaultProps: CreateOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CreateOutlineProps = { ...defaultProps, ...rest }
