...
type ArrowForwardCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ArrowForwardCircle({ extraStyles, extraClasses, ...rest }: ArrowForwardCircleProps) {
  const defaultProps: ArrowForwardCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ArrowForwardCircleProps = { ...defaultProps, ...rest }
