...
type PartlySunnyProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PartlySunny({ extraStyles, extraClasses, ...rest }: PartlySunnyProps) {
  const defaultProps: PartlySunnyProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PartlySunnyProps = { ...defaultProps, ...rest }
