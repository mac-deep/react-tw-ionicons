...
export default function CloseCircle({ extraStyles, extraClasses, ...rest }: CloseCircleProps) {
  const defaultProps: CloseCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloseCircleProps = { ...defaultProps, ...rest }
