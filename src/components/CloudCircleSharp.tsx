...
type CloudCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudCircleSharp({ extraStyles, extraClasses, ...rest }: CloudCircleSharpProps) {
  const defaultProps: CloudCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudCircleSharpProps = { ...defaultProps, ...rest }
