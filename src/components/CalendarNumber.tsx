...
export default function CalendarNumber({ extraStyles, extraClasses, ...rest }: CalendarNumberProps) {
  const defaultProps: CalendarNumberProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CalendarNumberProps = { ...defaultProps, ...rest }
