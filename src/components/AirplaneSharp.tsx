...
type AirplaneSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AirplaneSharp({ extraStyles, extraClasses, ...rest }: AirplaneSharpProps) {
  const defaultProps: AirplaneSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AirplaneSharpProps = { ...defaultProps, ...rest }
