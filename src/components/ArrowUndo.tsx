...
export default function ArrowUndo({ extraStyles, extraClasses, ...rest }: ArrowUndoProps) {
  const defaultProps: ArrowUndoProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ArrowUndoProps = { ...defaultProps, ...rest }
