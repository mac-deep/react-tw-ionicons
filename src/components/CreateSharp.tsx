...
type CreateSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CreateSharp({ extraStyles, extraClasses, ...rest }: CreateSharpProps) {
  const defaultProps: CreateSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CreateSharpProps = { ...defaultProps, ...rest }
