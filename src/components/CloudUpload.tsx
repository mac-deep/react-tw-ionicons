...
export default function CloudUpload({ extraStyles, extraClasses, ...rest }: CloudUploadProps) {
  const defaultProps: CloudUploadProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudUploadProps = { ...defaultProps, ...rest }
