...
type MusicalNotesOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MusicalNotesOutline({ extraStyles, extraClasses, ...rest }: MusicalNotesOutlineProps) {
  const defaultProps: MusicalNotesOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MusicalNotesOutlineProps = { ...defaultProps, ...rest }
