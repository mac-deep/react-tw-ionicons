...
type CameraReverseProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CameraReverse({ extraStyles, extraClasses, ...rest }: CameraReverseProps) {
  const defaultProps: CameraReverseProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CameraReverseProps = { ...defaultProps, ...rest }
