...
type FootballSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FootballSharp({ extraStyles, extraClasses, ...rest }: FootballSharpProps) {
  const defaultProps: FootballSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FootballSharpProps = { ...defaultProps, ...rest }
