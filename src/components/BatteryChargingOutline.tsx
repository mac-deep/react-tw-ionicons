...
type BatteryChargingOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BatteryChargingOutline({ extraStyles, extraClasses, ...rest }: BatteryChargingOutlineProps) {
  const defaultProps: BatteryChargingOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BatteryChargingOutlineProps = { ...defaultProps, ...rest }
