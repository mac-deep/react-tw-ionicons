...
type BuildOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BuildOutline({ extraStyles, extraClasses, ...rest }: BuildOutlineProps) {
  const defaultProps: BuildOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BuildOutlineProps = { ...defaultProps, ...rest }
