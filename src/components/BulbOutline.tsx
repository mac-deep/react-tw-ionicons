...
type BulbOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BulbOutline({ extraStyles, extraClasses, ...rest }: BulbOutlineProps) {
  const defaultProps: BulbOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BulbOutlineProps = { ...defaultProps, ...rest }
