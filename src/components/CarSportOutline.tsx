...
type CarSportOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CarSportOutline({ extraStyles, extraClasses, ...rest }: CarSportOutlineProps) {
  const defaultProps: CarSportOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CarSportOutlineProps = { ...defaultProps, ...rest }
