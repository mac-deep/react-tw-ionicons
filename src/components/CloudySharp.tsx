...
type CloudySharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudySharp({ extraStyles, extraClasses, ...rest }: CloudySharpProps) {
  const defaultProps: CloudySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudySharpProps = { ...defaultProps, ...rest }
