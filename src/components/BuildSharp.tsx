...
type BuildSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BuildSharp({ extraStyles, extraClasses, ...rest }: BuildSharpProps) {
  const defaultProps: BuildSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BuildSharpProps = { ...defaultProps, ...rest }
