...
export default function BoatSharp({ extraStyles, extraClasses, ...rest }: BoatSharpProps) {
  const defaultProps: BoatSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BoatSharpProps = { ...defaultProps, ...rest }
