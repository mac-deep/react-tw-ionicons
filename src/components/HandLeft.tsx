...
export default function HandLeft({ extraStyles, extraClasses, ...rest }: HandLeftProps) {
  const defaultProps: HandLeftProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HandLeftProps = { ...defaultProps, ...rest }
