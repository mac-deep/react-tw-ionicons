...
type PizzaOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PizzaOutline({ extraStyles, extraClasses, ...rest }: PizzaOutlineProps) {
  const defaultProps: PizzaOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PizzaOutlineProps = { ...defaultProps, ...rest }
