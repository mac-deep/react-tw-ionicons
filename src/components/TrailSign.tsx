...
export default function TrailSign({ extraStyles, extraClasses, ...rest }: TrailSignProps) {
  const defaultProps: TrailSignProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TrailSignProps = { ...defaultProps, ...rest }
