...
type VolumeHighProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function VolumeHigh({ extraStyles, extraClasses, ...rest }: VolumeHighProps) {
  const defaultProps: VolumeHighProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VolumeHighProps = { ...defaultProps, ...rest }
