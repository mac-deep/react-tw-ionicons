...
type ChatbubbleEllipsesProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ChatbubbleEllipses({ extraStyles, extraClasses, ...rest }: ChatbubbleEllipsesProps) {
  const defaultProps: ChatbubbleEllipsesProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ChatbubbleEllipsesProps = { ...defaultProps, ...rest }
