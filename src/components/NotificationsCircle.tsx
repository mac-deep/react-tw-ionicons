...
type NotificationsCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NotificationsCircle({ extraStyles, extraClasses, ...rest }: NotificationsCircleProps) {
  const defaultProps: NotificationsCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NotificationsCircleProps = { ...defaultProps, ...rest }
