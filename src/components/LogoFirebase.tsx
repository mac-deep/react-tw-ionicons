...
type LogoFirebaseProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoFirebase({ extraStyles, extraClasses, ...rest }: LogoFirebaseProps) {
  const defaultProps: LogoFirebaseProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoFirebaseProps = { ...defaultProps, ...rest }
