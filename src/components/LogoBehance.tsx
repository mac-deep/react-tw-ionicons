...
type LogoBehanceProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoBehance({ extraStyles, extraClasses, ...rest }: LogoBehanceProps) {
  const defaultProps: LogoBehanceProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoBehanceProps = { ...defaultProps, ...rest }
