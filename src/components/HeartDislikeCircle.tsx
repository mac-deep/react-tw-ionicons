...
type HeartDislikeCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartDislikeCircle({ extraStyles, extraClasses, ...rest }: HeartDislikeCircleProps) {
  const defaultProps: HeartDislikeCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartDislikeCircleProps = { ...defaultProps, ...rest }
