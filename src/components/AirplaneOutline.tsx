...
type AirplaneOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AirplaneOutline({ extraStyles, extraClasses, ...rest }: AirplaneOutlineProps) {
  const defaultProps: AirplaneOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AirplaneOutlineProps = { ...defaultProps, ...rest }
