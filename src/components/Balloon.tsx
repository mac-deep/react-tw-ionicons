...
export default function Balloon({ extraStyles, extraClasses, ...rest }: BalloonProps) {
  const defaultProps: BalloonProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BalloonProps = { ...defaultProps, ...rest }
