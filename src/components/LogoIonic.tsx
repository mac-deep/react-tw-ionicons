...
export default function LogoIonic({ extraStyles, extraClasses, ...rest }: LogoIonicProps) {
  const defaultProps: LogoIonicProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoIonicProps = { ...defaultProps, ...rest }
