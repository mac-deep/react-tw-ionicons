...
export default function Navigate({ extraStyles, extraClasses, ...rest }: NavigateProps) {
  const defaultProps: NavigateProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NavigateProps = { ...defaultProps, ...rest }
