...
export default function BodyOutline({ extraStyles, extraClasses, ...rest }: BodyOutlineProps) {
  const defaultProps: BodyOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BodyOutlineProps = { ...defaultProps, ...rest }
