...
type PowerSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PowerSharp({ extraStyles, extraClasses, ...rest }: PowerSharpProps) {
  const defaultProps: PowerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PowerSharpProps = { ...defaultProps, ...rest }
