...
type HeartSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HeartSharp({ extraStyles, extraClasses, ...rest }: HeartSharpProps) {
  const defaultProps: HeartSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartSharpProps = { ...defaultProps, ...rest }
