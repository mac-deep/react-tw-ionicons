...
type PeopleOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PeopleOutline({ extraStyles, extraClasses, ...rest }: PeopleOutlineProps) {
  const defaultProps: PeopleOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PeopleOutlineProps = { ...defaultProps, ...rest }
