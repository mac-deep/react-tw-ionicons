...
export default function EarSharp({ extraStyles, extraClasses, ...rest }: EarSharpProps) {
  const defaultProps: EarSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EarSharpProps = { ...defaultProps, ...rest }
