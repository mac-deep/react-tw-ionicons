...
type CloudCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudCircle({ extraStyles, extraClasses, ...rest }: CloudCircleProps) {
  const defaultProps: CloudCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudCircleProps = { ...defaultProps, ...rest }
