...
type LogoDesignernewsProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoDesignernews({ extraStyles, extraClasses, ...rest }: LogoDesignernewsProps) {
  const defaultProps: LogoDesignernewsProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoDesignernewsProps = { ...defaultProps, ...rest }
