...
type SubwaySharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SubwaySharp({ extraStyles, extraClasses, ...rest }: SubwaySharpProps) {
  const defaultProps: SubwaySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SubwaySharpProps = { ...defaultProps, ...rest }
