...
type StorefrontOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function StorefrontOutline({ extraStyles, extraClasses, ...rest }: StorefrontOutlineProps) {
  const defaultProps: StorefrontOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: StorefrontOutlineProps = { ...defaultProps, ...rest }
