...
type ThumbsDownOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ThumbsDownOutline({ extraStyles, extraClasses, ...rest }: ThumbsDownOutlineProps) {
  const defaultProps: ThumbsDownOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThumbsDownOutlineProps = { ...defaultProps, ...rest }
