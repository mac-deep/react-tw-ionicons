...
type ExtensionPuzzleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ExtensionPuzzleSharp({ extraStyles, extraClasses, ...rest }: ExtensionPuzzleSharpProps) {
  const defaultProps: ExtensionPuzzleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ExtensionPuzzleSharpProps = { ...defaultProps, ...rest }
