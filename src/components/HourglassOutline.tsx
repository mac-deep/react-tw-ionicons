...
type HourglassOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HourglassOutline({ extraStyles, extraClasses, ...rest }: HourglassOutlineProps) {
  const defaultProps: HourglassOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HourglassOutlineProps = { ...defaultProps, ...rest }
