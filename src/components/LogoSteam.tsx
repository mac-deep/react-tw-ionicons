...
export default function LogoSteam({ extraStyles, extraClasses, ...rest }: LogoSteamProps) {
  const defaultProps: LogoSteamProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoSteamProps = { ...defaultProps, ...rest }
