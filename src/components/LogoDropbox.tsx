...
type LogoDropboxProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoDropbox({ extraStyles, extraClasses, ...rest }: LogoDropboxProps) {
  const defaultProps: LogoDropboxProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoDropboxProps = { ...defaultProps, ...rest }
