...
export default function Barbell({ extraStyles, extraClasses, ...rest }: BarbellProps) {
  const defaultProps: BarbellProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BarbellProps = { ...defaultProps, ...rest }
