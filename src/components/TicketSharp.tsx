...
type TicketSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TicketSharp({ extraStyles, extraClasses, ...rest }: TicketSharpProps) {
  const defaultProps: TicketSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TicketSharpProps = { ...defaultProps, ...rest }
