...
export default function HandRight({ extraStyles, extraClasses, ...rest }: HandRightProps) {
  const defaultProps: HandRightProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HandRightProps = { ...defaultProps, ...rest }
