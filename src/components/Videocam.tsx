...
export default function Videocam({ extraStyles, extraClasses, ...rest }: VideocamProps) {
  const defaultProps: VideocamProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: VideocamProps = { ...defaultProps, ...rest }
