...
type ChevronCollapseProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ChevronCollapse({ extraStyles, extraClasses, ...rest }: ChevronCollapseProps) {
  const defaultProps: ChevronCollapseProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ChevronCollapseProps = { ...defaultProps, ...rest }
