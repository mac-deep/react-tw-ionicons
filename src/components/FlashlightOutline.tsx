...
type FlashlightOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FlashlightOutline({ extraStyles, extraClasses, ...rest }: FlashlightOutlineProps) {
  const defaultProps: FlashlightOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlashlightOutlineProps = { ...defaultProps, ...rest }
