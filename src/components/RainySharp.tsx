...
type RainySharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function RainySharp({ extraStyles, extraClasses, ...rest }: RainySharpProps) {
  const defaultProps: RainySharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: RainySharpProps = { ...defaultProps, ...rest }
