...
export default function BatteryCharging({ extraStyles, extraClasses, ...rest }: BatteryChargingProps) {
  const defaultProps: BatteryChargingProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BatteryChargingProps = { ...defaultProps, ...rest }
