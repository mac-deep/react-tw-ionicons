...
type AtCircleOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AtCircleOutline({ extraStyles, extraClasses, ...rest }: AtCircleOutlineProps) {
  const defaultProps: AtCircleOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AtCircleOutlineProps = { ...defaultProps, ...rest }
