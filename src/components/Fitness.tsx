...
export default function Fitness({ extraStyles, extraClasses, ...rest }: FitnessProps) {
  const defaultProps: FitnessProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FitnessProps = { ...defaultProps, ...rest }
