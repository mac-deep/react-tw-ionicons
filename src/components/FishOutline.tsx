...
type FishOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FishOutline({ extraStyles, extraClasses, ...rest }: FishOutlineProps) {
  const defaultProps: FishOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FishOutlineProps = { ...defaultProps, ...rest }
