...
type MedicalOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MedicalOutline({ extraStyles, extraClasses, ...rest }: MedicalOutlineProps) {
  const defaultProps: MedicalOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MedicalOutlineProps = { ...defaultProps, ...rest }
