...
export default function TextSharp({ extraStyles, extraClasses, ...rest }: TextSharpProps) {
  const defaultProps: TextSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TextSharpProps = { ...defaultProps, ...rest }
