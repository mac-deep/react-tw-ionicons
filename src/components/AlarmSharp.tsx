...
type AlarmSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function AlarmSharp({ extraStyles, extraClasses, ...rest }: AlarmSharpProps) {
  const defaultProps: AlarmSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AlarmSharpProps = { ...defaultProps, ...rest }
