...
type GitNetworkProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function GitNetwork({ extraStyles, extraClasses, ...rest }: GitNetworkProps) {
  const defaultProps: GitNetworkProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GitNetworkProps = { ...defaultProps, ...rest }
