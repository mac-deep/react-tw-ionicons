...
export default function BeerSharp({ extraStyles, extraClasses, ...rest }: BeerSharpProps) {
  const defaultProps: BeerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BeerSharpProps = { ...defaultProps, ...rest }
