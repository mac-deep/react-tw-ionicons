...
type RainyOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function RainyOutline({ extraStyles, extraClasses, ...rest }: RainyOutlineProps) {
  const defaultProps: RainyOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: RainyOutlineProps = { ...defaultProps, ...rest }
