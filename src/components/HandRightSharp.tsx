...
type HandRightSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HandRightSharp({ extraStyles, extraClasses, ...rest }: HandRightSharpProps) {
  const defaultProps: HandRightSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HandRightSharpProps = { ...defaultProps, ...rest }
