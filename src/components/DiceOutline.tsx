...
type DiceOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function DiceOutline({ extraStyles, extraClasses, ...rest }: DiceOutlineProps) {
  const defaultProps: DiceOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DiceOutlineProps = { ...defaultProps, ...rest }
