...
type RestaurantOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function RestaurantOutline({ extraStyles, extraClasses, ...rest }: RestaurantOutlineProps) {
  const defaultProps: RestaurantOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: RestaurantOutlineProps = { ...defaultProps, ...rest }
