...
type FlowerSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function FlowerSharp({ extraStyles, extraClasses, ...rest }: FlowerSharpProps) {
  const defaultProps: FlowerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FlowerSharpProps = { ...defaultProps, ...rest }
