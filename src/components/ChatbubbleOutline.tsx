...
type ChatbubbleOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ChatbubbleOutline({ extraStyles, extraClasses, ...rest }: ChatbubbleOutlineProps) {
  const defaultProps: ChatbubbleOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ChatbubbleOutlineProps = { ...defaultProps, ...rest }
