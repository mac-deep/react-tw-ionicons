...
type DiamondSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function DiamondSharp({ extraStyles, extraClasses, ...rest }: DiamondSharpProps) {
  const defaultProps: DiamondSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: DiamondSharpProps = { ...defaultProps, ...rest }
