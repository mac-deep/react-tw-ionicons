...
type TimerSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TimerSharp({ extraStyles, extraClasses, ...rest }: TimerSharpProps) {
  const defaultProps: TimerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TimerSharpProps = { ...defaultProps, ...rest }
