...
export default function LogoEuro({ extraStyles, extraClasses, ...rest }: LogoEuroProps) {
  const defaultProps: LogoEuroProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoEuroProps = { ...defaultProps, ...rest }
