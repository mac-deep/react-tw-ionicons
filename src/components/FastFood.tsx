...
export default function FastFood({ extraStyles, extraClasses, ...rest }: FastFoodProps) {
  const defaultProps: FastFoodProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: FastFoodProps = { ...defaultProps, ...rest }
