...
export default function LogoUsd({ extraStyles, extraClasses, ...rest }: LogoUsdProps) {
  const defaultProps: LogoUsdProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoUsdProps = { ...defaultProps, ...rest }
