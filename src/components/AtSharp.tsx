...
export default function AtSharp({ extraStyles, extraClasses, ...rest }: AtSharpProps) {
  const defaultProps: AtSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: AtSharpProps = { ...defaultProps, ...rest }
