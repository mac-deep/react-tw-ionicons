...
export default function HeartHalf({ extraStyles, extraClasses, ...rest }: HeartHalfProps) {
  const defaultProps: HeartHalfProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HeartHalfProps = { ...defaultProps, ...rest }
