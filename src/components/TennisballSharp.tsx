...
type TennisballSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function TennisballSharp({ extraStyles, extraClasses, ...rest }: TennisballSharpProps) {
  const defaultProps: TennisballSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TennisballSharpProps = { ...defaultProps, ...rest }
