...
type TransgenderProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function Transgender({ extraStyles, extraClasses, ...rest }: TransgenderProps) {
  const defaultProps: TransgenderProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: TransgenderProps = { ...defaultProps, ...rest }
