...
type NewspaperSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function NewspaperSharp({ extraStyles, extraClasses, ...rest }: NewspaperSharpProps) {
  const defaultProps: NewspaperSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: NewspaperSharpProps = { ...defaultProps, ...rest }
