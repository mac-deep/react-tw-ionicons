...
export default function PawSharp({ extraStyles, extraClasses, ...rest }: PawSharpProps) {
  const defaultProps: PawSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PawSharpProps = { ...defaultProps, ...rest }
