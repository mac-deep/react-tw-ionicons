...
type LogoDribbbleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoDribbble({ extraStyles, extraClasses, ...rest }: LogoDribbbleProps) {
  const defaultProps: LogoDribbbleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoDribbbleProps = { ...defaultProps, ...rest }
