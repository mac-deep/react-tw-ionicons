...
type EarthSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function EarthSharp({ extraStyles, extraClasses, ...rest }: EarthSharpProps) {
  const defaultProps: EarthSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EarthSharpProps = { ...defaultProps, ...rest }
