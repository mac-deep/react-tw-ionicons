...
type SparklesOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function SparklesOutline({ extraStyles, extraClasses, ...rest }: SparklesOutlineProps) {
  const defaultProps: SparklesOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: SparklesOutlineProps = { ...defaultProps, ...rest }
