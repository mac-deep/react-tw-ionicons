...
type CloudOfflineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CloudOffline({ extraStyles, extraClasses, ...rest }: CloudOfflineProps) {
  const defaultProps: CloudOfflineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CloudOfflineProps = { ...defaultProps, ...rest }
