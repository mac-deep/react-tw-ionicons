...
type HammerOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function HammerOutline({ extraStyles, extraClasses, ...rest }: HammerOutlineProps) {
  const defaultProps: HammerOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HammerOutlineProps = { ...defaultProps, ...rest }
