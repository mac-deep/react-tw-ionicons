...
type ServerSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ServerSharp({ extraStyles, extraClasses, ...rest }: ServerSharpProps) {
  const defaultProps: ServerSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ServerSharpProps = { ...defaultProps, ...rest }
