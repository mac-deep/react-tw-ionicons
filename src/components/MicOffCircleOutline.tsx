...
type MicOffCircleOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MicOffCircleOutline({ extraStyles, extraClasses, ...rest }: MicOffCircleOutlineProps) {
  const defaultProps: MicOffCircleOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MicOffCircleOutlineProps = { ...defaultProps, ...rest }
