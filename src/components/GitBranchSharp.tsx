...
type GitBranchSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function GitBranchSharp({ extraStyles, extraClasses, ...rest }: GitBranchSharpProps) {
  const defaultProps: GitBranchSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GitBranchSharpProps = { ...defaultProps, ...rest }
