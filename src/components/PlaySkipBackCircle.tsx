...
type PlaySkipBackCircleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PlaySkipBackCircle({ extraStyles, extraClasses, ...rest }: PlaySkipBackCircleProps) {
  const defaultProps: PlaySkipBackCircleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PlaySkipBackCircleProps = { ...defaultProps, ...rest }
