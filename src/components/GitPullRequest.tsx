...
export default function GitPullRequest({ extraStyles, extraClasses, ...rest }: GitPullRequestProps) {
  const defaultProps: GitPullRequestProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: GitPullRequestProps = { ...defaultProps, ...rest }
