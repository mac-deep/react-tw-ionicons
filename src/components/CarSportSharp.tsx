...
type CarSportSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function CarSportSharp({ extraStyles, extraClasses, ...rest }: CarSportSharpProps) {
  const defaultProps: CarSportSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: CarSportSharpProps = { ...defaultProps, ...rest }
