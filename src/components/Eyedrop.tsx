...
export default function Eyedrop({ extraStyles, extraClasses, ...rest }: EyedropProps) {
  const defaultProps: EyedropProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: EyedropProps = { ...defaultProps, ...rest }
