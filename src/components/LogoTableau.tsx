...
type LogoTableauProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function LogoTableau({ extraStyles, extraClasses, ...rest }: LogoTableauProps) {
  const defaultProps: LogoTableauProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: LogoTableauProps = { ...defaultProps, ...rest }
