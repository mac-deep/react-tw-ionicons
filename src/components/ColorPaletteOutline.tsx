...
type ColorPaletteOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ColorPaletteOutline({ extraStyles, extraClasses, ...rest }: ColorPaletteOutlineProps) {
  const defaultProps: ColorPaletteOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ColorPaletteOutlineProps = { ...defaultProps, ...rest }
