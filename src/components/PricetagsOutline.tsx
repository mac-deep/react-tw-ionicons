...
type PricetagsOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function PricetagsOutline({ extraStyles, extraClasses, ...rest }: PricetagsOutlineProps) {
  const defaultProps: PricetagsOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: PricetagsOutlineProps = { ...defaultProps, ...rest }
