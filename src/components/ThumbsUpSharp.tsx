...
type ThumbsUpSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function ThumbsUpSharp({ extraStyles, extraClasses, ...rest }: ThumbsUpSharpProps) {
  const defaultProps: ThumbsUpSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: ThumbsUpSharpProps = { ...defaultProps, ...rest }
