...
export default function Bonfire({ extraStyles, extraClasses, ...rest }: BonfireProps) {
  const defaultProps: BonfireProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BonfireProps = { ...defaultProps, ...rest }
