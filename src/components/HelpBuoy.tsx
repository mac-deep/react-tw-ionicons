...
export default function HelpBuoy({ extraStyles, extraClasses, ...rest }: HelpBuoyProps) {
  const defaultProps: HelpBuoyProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: HelpBuoyProps = { ...defaultProps, ...rest }
