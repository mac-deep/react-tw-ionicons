...
type WarningOutlineProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function WarningOutline({ extraStyles, extraClasses, ...rest }: WarningOutlineProps) {
  const defaultProps: WarningOutlineProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: WarningOutlineProps = { ...defaultProps, ...rest }
