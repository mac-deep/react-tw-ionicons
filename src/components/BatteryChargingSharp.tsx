...
type BatteryChargingSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function BatteryChargingSharp({ extraStyles, extraClasses, ...rest }: BatteryChargingSharpProps) {
  const defaultProps: BatteryChargingSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: BatteryChargingSharpProps = { ...defaultProps, ...rest }
