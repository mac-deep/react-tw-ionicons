...
type MicCircleSharpProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MicCircleSharp({ extraStyles, extraClasses, ...rest }: MicCircleSharpProps) {
  const defaultProps: MicCircleSharpProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MicCircleSharpProps = { ...defaultProps, ...rest }
