...
type MaleFemaleProps = {
  extraStyles?: SVGAttributes<SVGElement>['style']
  extraClasses?: SVGAttributes<SVGElement>['className']
} & Omit<SVGProps<SVGSVGElement>, 'style' | 'className'>

export default function MaleFemale({ extraStyles, extraClasses, ...rest }: MaleFemaleProps) {
  const defaultProps: MaleFemaleProps = {
    width: '20px',
    height: '20px',
    extraClasses: '',
  }

  const mergedProps: MaleFemaleProps = { ...defaultProps, ...rest }
