...
type CheckmarkDoneCircleSharpProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function CheckmarkDoneCircleSharp({ extraStyles, ...rest }: CheckmarkDoneCircleSharpProps) {
  const defaultProps: CheckmarkDoneCircleSharpProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: CheckmarkDoneCircleSharpProps = { ...defaultProps, ...rest }
  return (
    <>
