...
type NotificationsCircleOutlineProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function NotificationsCircleOutline({ extraStyles, ...rest }: NotificationsCircleOutlineProps) {
  const defaultProps: NotificationsCircleOutlineProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: NotificationsCircleOutlineProps = { ...defaultProps, ...rest }
  return (
    <>
