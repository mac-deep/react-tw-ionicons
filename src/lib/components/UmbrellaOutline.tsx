...
type UmbrellaOutlineProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function UmbrellaOutline({ extraStyles, ...rest }: UmbrellaOutlineProps) {
  const defaultProps: UmbrellaOutlineProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: UmbrellaOutlineProps = { ...defaultProps, ...rest }
  return (
    <>
