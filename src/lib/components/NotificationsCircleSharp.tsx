...
type NotificationsCircleSharpProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function NotificationsCircleSharp({ extraStyles, ...rest }: NotificationsCircleSharpProps) {
  const defaultProps: NotificationsCircleSharpProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: NotificationsCircleSharpProps = { ...defaultProps, ...rest }
  return (
    <>
