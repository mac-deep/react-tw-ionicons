...
type WomanOutlineProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function WomanOutline({ extraStyles, ...rest }: WomanOutlineProps) {
  const defaultProps: WomanOutlineProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: WomanOutlineProps = { ...defaultProps, ...rest }
  return (
    <>
