...
type NotificationsOffCircleSharpProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function NotificationsOffCircleSharp({ extraStyles, ...rest }: NotificationsOffCircleSharpProps) {
  const defaultProps: NotificationsOffCircleSharpProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: NotificationsOffCircleSharpProps = { ...defaultProps, ...rest }
  return (
    <>
