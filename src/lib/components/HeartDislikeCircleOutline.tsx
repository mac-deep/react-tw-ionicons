...
type HeartDislikeCircleOutlineProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function HeartDislikeCircleOutline({ extraStyles, ...rest }: HeartDislikeCircleOutlineProps) {
  const defaultProps: HeartDislikeCircleOutlineProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: HeartDislikeCircleOutlineProps = { ...defaultProps, ...rest }
  return (
    <>
