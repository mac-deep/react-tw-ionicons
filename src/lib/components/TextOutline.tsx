...
export default function TextOutline({ extraStyles, ...rest }: TextOutlineProps) {
  const defaultProps: TextOutlineProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: TextOutlineProps = { ...defaultProps, ...rest }
  return (
    <>
