...
type NotificationsOffCircleOutlineProps = {
  extraStyles?: React.SVGAttributes<SVGElement>['style']
} & Omit<SVGProps<SVGSVGElement>, 'style'>

export default function NotificationsOffCircleOutline({ extraStyles, ...rest }: NotificationsOffCircleOutlineProps) {
  const defaultProps: NotificationsOffCircleOutlineProps = {
    width: '20px',
    height: '20px',
    fill: 'currentColor',
  }

  const mergedProps: NotificationsOffCircleOutlineProps = { ...defaultProps, ...rest }
  return (
    <>
